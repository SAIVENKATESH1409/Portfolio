...
const Hero = () => {
    ...
    const handleResumeClick = () => {
        window.open("https://drive.google.com/file/d/1Wospb8tenRccqem9DBZgoiD8OW0dtfIF/view?usp=sharing", "_blank");
    };
                        ...
                        <div ref={ref}>
                            {inView ? (
                                <Fade delay={5} duration={1000}>
                                    <h2 className="font-poppins font-bold text-2xl md:text-3xl lg:text-4xl">I am Sai Venkatesh Aravapalli.</h2>
                                </Fade>
                            ) : (
                                <h2 className="font-poppins text-2xl md:text-3xl lg:text-4xl">I am Sai Venkatesh Aravapalli.</h2>
                            )}
                        </div>
